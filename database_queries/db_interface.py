...
DATA_VIZ_REQUIRED_ALGORITHM_CONFIG_KEY = 'data_viz_required_algorithms'
...
class DataVizDatabaseInterface(AlgorithmDatabaseInterface):
    ...
    def get_training_inputs_auto_readable(self, set_name):
        ...
        transaction_query = queries.TransactionQuery.select_transactions_info_from_id_list_readable(list_ids)
